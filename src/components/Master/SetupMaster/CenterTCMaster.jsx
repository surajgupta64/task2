...
const CenterTcMaster = () => {
  ...
  const column = [
    ...
    { heading: "Category Name", value: "category" },
    { heading: "Product Name", value: "product" },

    {
      heading: "Activation",
      btn1: <ToggleButton text={true} />,
    },
    {
      heading: "Options",
      btn1: (
  ...
  const Users = [
    {
      id: 1,
      category: "T & C In-studio",
      product: "CRM, Front Desk",
    },
    {
      id: 2,
      category: "T & C In-studio",
